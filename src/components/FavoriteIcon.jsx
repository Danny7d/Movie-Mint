...
function FavoriteIcon({ movieId, movie, className = "" }) {
  ...
  return (
    <button
      ...
      className={`absolute bottom-2 right-2 p-2 rounded-full transition-all duration-300 z-96 ${isFavorited ? "bg-red-500" : "bg-gray-800/80 hover:bg-gray-700"} ${className}`}
